...
const site = { ...DEFAULT_SITE, ...getSavedJSON("heetherapySite", {}) };
const savedTherapists = getSavedJSON("heetherapyManagers", null);
const activeTherapists = Array.isArray(savedTherapists) && savedTherapists.length ? savedTherapists : therapists;
...
function updateLinks() {
  document.querySelectorAll('a[href^="tel:"]').forEach((a) => a.href = `tel:${site.phone.replace(/[^0-9]/g, "")}`);
  document.querySelectorAll('a[href^="https://t.me/"]').forEach((a) => a.href = site.telegram);
    ...
    <div class="premium-profile">
      ...
      <div class="premium-info">
        ...
        <div class="premium-actions">
          ...
          <a class="btn dark" href="tel:${site.phone.replace(/[^0-9]/g, "")}">전화예약</a>
        </div>
...
if (eventGrid) {
  ...
  <div class="event-text">${site.eventText1.replace(/\n/g, "<br>")}</div>
    ...
    <article class="event-card">
      ...
      <div class="event-text">${site.eventText2.replace(/\n/g, "<br>")}</div>
    </article>
  `;
}